...
async function main(): Promise<void> {
  ...
  writeFileSync(resolve(EVALS_DIR, "architecture-comparison.json"), JSON.stringify(out, null, 2));
  ...
  writeFileSync(resolve(EVALS_DIR, "architecture-comparison.md"), md.join("\n"));
